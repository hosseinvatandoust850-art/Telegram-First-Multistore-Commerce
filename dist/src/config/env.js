...
function publicUrl() {
    ...
    return {
        error: 'APP_URL is required in production (or expose RAILWAY_PUBLIC_DOMAIN). ' +
...
function parse() {
    ...
    if (isProduction && !process.env.DATABASE_URL) {
        missing.push('DATABASE_URL — connect a Railway PostgreSQL service and set ' +
    ...
    return {
        ...
        ton: {
            ...
            provider: process.env.TON_PROVIDER || 'toncenter',
        ...
        storage: {
            ...
            publicBaseUrl: process.env.STORAGE_URL ||
